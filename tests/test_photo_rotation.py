...
def test_photo_folder_rotation(temp_workspace):
    ...
    with (
        ...
        patch(
            "zen_prompt.commands.random.get_photo_renderable", return_value="renderable"
        ),
        patch("zen_prompt.commands.random.render_photo"),
        patch("zen_prompt.commands.random._render_photo_table_layout"),
    ):
